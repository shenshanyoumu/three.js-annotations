...
Geometry.prototype = Object.assign(Object.create(EventDispatcher.prototype), {
  ...
  // 几何模型的“lookAt"采样了Object3D模型的”LookAt“
  lookAt: (function() {
    ...
    return function lookAt(vector) {
      ...
      // 几何模型进行矩阵变换，就会修改其”LookAt“的目标点
      this.applyMatrix(obj.matrix);
    };
  })(),

  // 从bufferGeometry得到一个geometry对象，需要根据buffer结构来拆解几何模型的各个要素
